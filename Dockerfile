...
COPY --from=mlocati/php-extension-installer:2.1.58 /usr/bin/install-php-extensions /usr/bin/
COPY --from=ghcr.io/roadrunner-server/roadrunner:2023.3.4 /usr/bin/rr /usr/local/bin/rr
